...
describe('consignorstatementsComponent', () => {
  ...
  beforeEach(() => {
    mockConsignorService.getStatements.and.returnValue(of(mockStatements));
  ...
  it('should load statements on init', fakeAsync(() => {
    ...
    expect(mockConsignorService.getStatements).toHaveBeenCalled();
  ...
  it('should show error state', fakeAsync(() => {
    ...
    mockConsignorService.getStatements.and.returnValue(throwError(() => new Error('API Error')));
  ...
  it('should show empty state when no statements', fakeAsync(() => {
    ...
    mockConsignorService.getStatements.and.returnValue(of([]));
  ...
  it('should download PDF successfully', fakeAsync(() => {
    ...
    expect(mockConsignorService.downloadStatementPdf).toHaveBeenCalledWith('1');
