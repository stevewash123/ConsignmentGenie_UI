  ...
  async loadNotificationSettings(): Promise<void> {
    try {
      const settings = await firstValueFrom(
        this.http.get<ConsignorNotificationSettings>(`${environment.apiUrl}/api/settings/consignor/consignor-onboarding`)
      );
  ...
  async updateNotificationSettings(settings: Partial<ConsignorNotificationSettings>): Promise<void> {
    ...
    try {
      const response = await firstValueFrom(
        this.http.patch<ConsignorNotificationSettings>(`${environment.apiUrl}/api/settings/consignor/consignor-onboarding`, updated)
      );
