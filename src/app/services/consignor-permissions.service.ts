  ...
  async loadConsignorPermissions(): Promise<void> {
    try {
      const permissions = await firstValueFrom(
        this.http.get<ConsignorPermissions>(`${environment.apiUrl}/api/settings/consignor/consignor-onboarding`)
      );
  ...
  private async savePermissions(): Promise<void> {
    ...
    try {
      const response = await firstValueFrom(
        this.http.patch<{success: boolean, data: ConsignorPermissions}>(`${environment.apiUrl}/api/settings/consignor/consignor-onboarding`, changesToSave)
      );
