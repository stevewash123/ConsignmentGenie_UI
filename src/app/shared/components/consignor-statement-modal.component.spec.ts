...
describe('ConsignorStatementModalComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ConsignorStatementModalComponent],
      providers: [
  ...
  describe('SMOKE', () => {
    it('should render with data without console errors', () => {
      ...
      const fixture = TestBed.createComponent(ConsignorStatementModalComponent);
