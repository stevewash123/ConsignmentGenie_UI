...
describe('BalanceAdjustmentModalComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [BalanceAdjustmentModalComponent],
      providers: [
  ...
  describe('SMOKE', () => {
    it('should render with data without console errors', () => {
      ...
      const fixture = TestBed.createComponent(BalanceAdjustmentModalComponent);
