...
import { AdminNotificationPreferencesComponent } from './admin-notification-preferences.component';
import { ConsoleErrorTracker } from '@testing/console-error-tracker';

/**
 * Smoke tests for AdminNotificationPreferencesComponent
 * 
 * These tests verify that the component renders without console errors
 * in common states and after primary user actions.
 */
describe('AdminNotificationPreferencesComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [AdminNotificationPreferencesComponent],
      providers: [
  ...
  describe('SMOKE', () => {
    it('should render with data without console errors', () => {
      ...
      const fixture = TestBed.createComponent(AdminNotificationPreferencesComponent);
