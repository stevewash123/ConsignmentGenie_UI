...
describe('OwnerInvitationsListComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [OwnerInvitationsListComponent],
      providers: [
  ...
  describe('SMOKE', () => {
    it('should render with data without console errors', () => {
      ...
      const fixture = TestBed.createComponent(OwnerInvitationsListComponent);
