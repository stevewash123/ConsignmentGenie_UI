      ...
      <div class="container">
        <div class="auth-card">
          <div class="header">
            ...
            <h1>LOGIN</h1>
            <p class="subtitle">Choose your method to log in as a Provider</p>
          </div>
          ...
          <form [formGroup]="authForm" (ngSubmit)="onSubmit()">
            ...
            <button
              ...
              {{ isSubmitting() ? 'Creating Account...' : 'Continue to Provider Details' }}
            </button>
          </form>
...
export class ProviderSignupStep1Component implements OnInit {
  ...
  onSubmit() {
    ...
    setTimeout(() => {
      ...
      // Navigate to step 2
      this.router.navigate(['/signup/provider/details']);
    }, 1000);
  }
