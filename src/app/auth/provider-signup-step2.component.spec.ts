...
import { ProviderSignupStep2Component } from './provider-signup-step2.component';
...
@Component({ template: '' })
class MockProviderSignupStep1Component { }

describe('ProviderSignupStep2Component', () => {
  let component: ProviderSignupStep2Component;
  let fixture: ComponentFixture<ProviderSignupStep2Component>;
  let router: Router;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [
        ProviderSignupStep2Component,
        RouterTestingModule.withRoutes([
          { path: 'login', component: MockLoginComponent },
          { path: 'signup/provider', component: MockProviderSignupStep1Component }
        ])
      ],
      providers: [
    ...
    fixture = TestBed.createComponent(ProviderSignupStep2Component);
  ...
  describe('ngOnInit', () => {
    ...
    it('should redirect to step 1 if no auth data exists', () => {
      ...
      expect(router.navigate).toHaveBeenCalledWith(['/signup/provider']);
    });
  });
  ...
  it('should have proper navigation links', () => {
    ...
    expect(backLink?.getAttribute('routerLink')).toBe('/signup/provider');
