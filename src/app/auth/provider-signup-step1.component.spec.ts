...
describe('ProviderSignupStep1Component', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [
        ProviderSignupStep1Component,
        RouterTestingModule.withRoutes([
          { path: 'signup/provider/details', component: ProviderSignupStep1Component }
        ])
      ],
      providers: [
        FormBuilder,
  ...
  it('should display the correct title and description', () => {
    ...
    expect(compiled.querySelector('.subtitle')?.textContent?.trim())
      .toBe('Choose your method to log in as a Provider');
  });
  ...
  it('should show correct button text', () => {
    ...
    expect(submitButton.textContent?.trim()).toBe('Continue to Provider Details');
  ...
  describe('Navigation and UI Elements', () => {
    ...
    it('should use purple theme for provider branding', () => {
      const compiled = fixture.nativeElement as HTMLElement;

      // Check if the component has provider-specific styling
    ...
    it('should display provider-specific subtitle', () => {
      const compiled = fixture.nativeElement as HTMLElement;
