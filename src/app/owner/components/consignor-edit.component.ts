...
export class ConsignorEditComponent implements OnInit {
  ...
  populateEditData(consignor: Consignor): void {
    this.editData = {
      ...
      addressLine1: '', // These will be populated from detailed API call if available
      addressLine2: '',
      city: '',
      state: '',
      postalCode: '',
  ...
  onSubmit(): void {
    ...
    const updateRequest: UpdateConsignorRequest = {
      ...
      addressLine1: this.editData.addressLine1 || undefined,
      addressLine2: this.editData.addressLine2 || undefined,
      city: this.editData.city || undefined,
      state: this.editData.state || undefined,
      postalCode: this.editData.postalCode || undefined,
