...
describe('SquareConnectionComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [SquareConnectionComponent],
      providers: [
  ...
  describe('SMOKE', () => {
    it('should render with data without console errors', () => {
      ...
      const fixture = TestBed.createComponent(SquareConnectionComponent);
